  ...
  const submitLead = () => {
    ...
    return (
        <Layout>
            ...
            <Button onClick={()=>toggleModal(true)} style={{marginTop:"50px" ,padding: "10px 20px", fontSize: "20px"}}>
              Download Free Trial
            </Button>
          </Banner>
            ...
            <RDiv style={{paddingBottom: "100px"}}>
              <Card>
                  ...
                  <div style={{flexDirection: "column", marginLeft: "20px",flexBasis: "70%", padding: "10px"}}>
                    ...
                    <div style={{fontSize: "12px",padding: "0px 0px", color: "#172647"}}>
                      Use this to accurately predict the high and low of the day with great precision.<br/><br/>
                    </div>
                    <div style={{fontSize: "14px",padding: "0px 0px", color: "#4B586A"}}>
